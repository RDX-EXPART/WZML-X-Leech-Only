...
╭ <b>Status</b> » No active bot tasks
╰ <b>Tip</b> » Use <code>/{BotCommands.StatusCommand[0]} me</code> to see only your tasks

━━━━━━━━━━━━━━━━━━
🔸 <b>RDX STATS</b> 🔹
╭ <b>CPU</b> » {cpu_percent()}% | <b>FREE</b> » {free}
├ <b>RAM</b> » {virtual_memory().percent}% | <b>UP</b> » {currentTime}
╰ <b>Disk Free</b> » {round(100 - disk_usage(DOWNLOAD_DIR).percent, 1)}%
"""
...
├ <b>Queue DL</b> » {tasks["QueueDl"]} | <b>Queue UP</b> » {tasks["QueueUp"]}
├ <b>Paused</b> » {tasks["Pause"]} | <b>Sample</b> » {tasks["SamVid"]}
╰ <b>Convert</b> » {tasks["ConvertMedia"]} | <b>FFmpeg</b> » {tasks["FFmpeg"]}

━━━━━━━━━━━━━━━━━━
╭ <b>Download Speed</b> » {get_readable_file_size(dl_speed)}/s
├ <b>Upload Speed</b> » {get_readable_file_size(up_speed)}/s
╰ <b>Seeding Speed</b> » {get_readable_file_size(seed_speed)}/s
"""
        button = ButtonMaker()
